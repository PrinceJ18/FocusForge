...
import { Calendar, Clock, RotateCcw, FolderPlus } from 'lucide-react';
              ...
              {recurrenceType !== 'none' && (
                <div>
                  ...
                  {errors.recurrenceInterval && (
                    <p className="text-xs text-red-400 mt-1">{errors.recurrenceInterval}</p>
                  )}
                </div>
              )}
            </div>
            ...
            {recurrenceType === 'weekdays' && (
              <div>
                ...
                {errors.recurrenceWeekdays && (
                  <p className="text-xs text-red-400 mt-1">{errors.recurrenceWeekdays}</p>
                )}
              </div>
            )}
