  ...
  return (
    <>
      ...
      <aside
        ...
        style={{ zIndex: 101, height: '100vh', overflow: 'hidden' }}
      ...
      >
        ...
        {user && (
          <div className="sidebar-profile mx-4 mb-4 p-3 rounded-14" style={{ background: 'rgba(168,85,247,0.08)', border: '1px solid rgba(168,85,247,0.2)', borderRadius: 12, transition: 'padding 250ms ease, margin 250ms ease' }}>
