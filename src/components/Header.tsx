  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        <button
          onClick={onMenuClick}
          className="md:hidden p-2 rounded-10 btn-ghost"
      ...
      <div className="flex items-center gap-3">
        ...
        {profile.streak > 0 && (
          <div
            className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-full text-sm font-medium"
...
function LoginButton({ onClick }: { onClick: () => void }) {
  return (
    <button
      onClick={onClick}
      className="btn-neon px-4 py-2 text-sm font-medium flex items-center gap-2"
