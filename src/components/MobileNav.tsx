...
export default function MobileNav() {
  ...
  return (
    <nav aria-label="Mobile navigation" className="mobile-nav flex items-center justify-around px-1 py-1.5" style={{ paddingBottom: 'calc(env(safe-area-inset-bottom) + 6px)' }}>
      {items.map((item) => (
        <button
          key={item.id}
